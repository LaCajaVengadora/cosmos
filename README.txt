...
Para poder editarlo POR PRIMERA VEZ:
1- Instalar python (https://www.python.org/ftp/python/3.12.7/python-3.12.7-amd64.exe) (and venv)
...
>>> git config user.name "Valen"; git config user.email "valucomvaz@gmail.com"

LA PRÓXIMA VEZ que quieran editar el proyecto, los pasos serían:
- Activar el venv con >>>cd PROJECT/280924/myenv/Scripts; activate; cd ../..
- En el dir 280924 ejecutar (myenv) >>> git pull origin main
- Hacer todos los cambios que quieran
- Ejecutar (myenv) >>> git commit -am "Descripción de los cambios"; git push origin main
- Desactivar el venv con >>> deactivate