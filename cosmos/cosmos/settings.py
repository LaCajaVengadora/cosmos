...
ALLOWED_HOSTS = ['192.168.56.1', "127.0.0.1", "192.168.27.18"]
...
INSTALLED_APPS = [
    ...
    'contact_app', 'uni_app', 'auth_app', 'blog_app'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': ['uni_app/templates', 'cosmos/parent_templates', 'auth_app/templates', 'blog_app/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
